from annotationdb import ncbi_search
import argparse
import time
import numpy as np
import pandas as pd
...
if __name__ == "__main__":
    ...
    output_file = os.path.join(folder, "probe_refseq_annotation.txt")
    ...
    for id in range(n_probes):
        ...
        if dbname == "Mm2Rn5" or dbname == "RefSeq":
            genename = ncbi_search(accession)
            time.sleep(1.5)
